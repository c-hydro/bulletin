...
#-----------------------------------------------------------------------------------------
# Script information
script_name='BULLETIN - HYDRO - GLOFAS'
...
script_file=$script_folder'/fp_bulletin_hydro_glofas.py'
settings_file=$fp_folder'fp_tools_postprocessing/fp_bulletin_hydro_glofas_africa.json'

# Get information (-u to get gmt time)
#hour_run=00
time_now=$(date -u +"%Y-%m-%d 00:00")
#time_now='2021-10-17 00:00' # DEBUG

# Get lock information
file_lock_start_raw='fp_africa_hydro_glofas_%YYYY%MM%DD_%HH_START.txt'
file_lock_end_raw='fp_africa_hydro_glofas_%YYYY%MM%DD_%HH_END.txt'
